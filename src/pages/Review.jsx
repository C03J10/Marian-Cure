...
function Reportform() {
  return (
    <>
      <div className='h-[100em] w-full flex items-center justify-center gradientRight m-auto mt-8'>

        <div className='h-[94em] w-4/5 flex flex-col bg-white text-black p-12 rounded-xl relative top-[1em]'>
          ...
          <div className='bg-pink-400 h-14 font-bold absolute w-4/5 flex items-center justify-center mx-auto top-96 left-32'> 
            ...
            <input type="text" id='concerninput' placeholder='Input your concern here:' 
            ...
            <input type="text" id='previousmedicationinput' placeholder='Input your previous medications here:' 
                    className='absolute h-[10em] rounded-lg w-[60.5em] px-4 font-normal top-[18em] left-0' /> 
          </div>

          <div className='bg-pink-400 h-14 font-bold absolute w-4/5 flex items-center justify-center mx-auto bottom-[37em] left-32'> 
            <h3> Current Medication</h3>
            <input type="text" id='currentmedicationinput' placeholder='Input your previous medications here:' 
                    className='absolute h-[10em] rounded-lg w-[60.5em] px-4 font-normal top-[5em] left-0' /> 
          </div>

          <div className='bg-pink-400 h-14 font-bold absolute w-4/5 flex items-center justify-center mx-auto bottom-[20em] left-32'> 
            <h3> Recommendation</h3>
            <input type="text" id='recommendationinput' placeholder='Place your recommendation here:' 
                    className='absolute h-[10em] rounded-lg w-[60.5em] px-4 font-normal top-[5em] left-0' /> 

           <div>
            <input type="text" id='signatureinput' placeholder='       (Name here)' 
                    className='absolute h-[2em] border-0 w-[12em] px-4 font-normal top-[11em] right-[2em]' /> 

            <p className='absolute px-4 font-normal top-[13em] right-[2em]'>Signature of Pharmacist</p>
          
            </div> 
            <p className='absolute px-4 font-normal top-[12em] right-[2em]'>__________________________</p>
          </div>

          <button className='h-12 w-48 bottom-1 absolute buttonMain justify-center items-center flex m-auto text-white mb-4 right-[28em]'>Submit</button>
